...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // window.addEventListener(`hashchange`, selectedRecipe);
var _runtime = require("regenerator-runtime/runtime");
var _modelJs = require("./model.js");
var _recipeViewJs = require("./views/recipeView.js");
var _recipeViewJsDefault = parcelHelpers.interopDefault(_recipeViewJs);
var _searchBarViewJs = require("./views/searchBarView.js");
var _searchBarViewJsDefault = parcelHelpers.interopDefault(_searchBarViewJs);
...
var _pageButtonViewJs = require("./views/pageButtonView.js");
var _pageButtonViewJsDefault = parcelHelpers.interopDefault(_pageButtonViewJs);
...
function initalize() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerNewServings(controlServings);
    (0, _recipeViewJsDefault.default).AddBookmarkHandler(controlToggleBookmark);
    (0, _searchBarViewJsDefault.default).addHandlerSearch(controlSearch);
    (0, _pageButtonViewJsDefault.default).addPageHandler(controlPageButtons);
    (0, _addRecipeViewJsDefault.default).addHandlerAddRecipe();
    (0, _addRecipeViewJsDefault.default).addHandlerCloseRecipe();
    (0, _addRecipeViewJsDefault.default).addHandlerSubmitRecipe(controlSubmitRecipe);
}
initalize();
async function controlRecipe() {
    try {
        ...
        (0, _searchResultsViewJsDefault.default).update(_modelJs.searchResultsPage());
        // console.log(`test`);
        // debugger;
        (0, _bookmarksViewJsDefault.default).update(_modelJs.state.bookmarks);
        await _modelJs.loadSelectedRecipe(id);
...
async function controlSearch() {
    try {
        const searchQuery = (0, _searchBarViewJsDefault.default).getQuery();
        // console.log(searchQuery);
        if (!searchQuery) return;
        (0, _searchResultsViewJsDefault.default).loadingSpinner();
        await _modelJs.loadSearchResults(searchQuery);
        console.log(_modelJs.state.search);
        (0, _searchResultsViewJsDefault.default).render(_modelJs.searchResultsPage(1));
        (0, _pageButtonViewJsDefault.default).render(_modelJs.state.search);
    } catch (error) {
        console.log(error);
    }
}
...
function controlPageButtons(targetPage) {
    (0, _searchResultsViewJsDefault.default).render(_modelJs.searchResultsPage(targetPage));
    (0, _pageButtonViewJsDefault.default).render(_modelJs.state.search);
}
...
function controlToggleBookmark() {
    if (!_modelJs.state.recipe.bookmarked) // console.log(`boomark`, Model.state.recipe);
    _modelJs.addBookmark(_modelJs.state.recipe);
    else // console.log(`unbookmark`, Model.state.recipe);
    _modelJs.removeBookmark(_modelJs.state.recipe);
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe);
    (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
}
...
parcelHelpers.export(exports, "loadSelectedRecipe", ()=>loadSelectedRecipe);
...
async function loadSelectedRecipe(id) {
    try {
        ...
        if (state.bookmarks.some(function(value) {
            return value.id === id;
...
async function loadSearchResults(searchQuery) {
    try {
        ...
        const data = await (0, _helper.AJAX)(`${(0, _config.API_URL)}?search=${searchQuery}&key=${(0, _config.API_KEY)}`);
...
function searchResultsPage(pageNumber = state.search.currentPage) {
    // const firstPage = 0;
...
async function uploadRecipe(newRecipe) {
    ...
    try {
        ...
        const ingredients = ingredientsArray.map(function(ingredient) {
            const ingredients = ingredient[1]// .replaceAll(` `, ``)
        ...
        // console.log(recipe);
        const response = await (0, _helper.AJAX)(`${(0, _config.API_URL)}?key=${(0, _config.API_KEY)}`, recipe);
...
const API_KEY = `8cf4d7b7-f12f-4311-a57b-a440d95f1872`;
...
async function postJSON(url, recipe) {
    try {
        const response = await Promise.race([
            fetch(url, {
                method: `POST`,
...
async function AJAX(url, info) {
    try {
        const fetchData = info ? fetch(url, {
            method: `POST`,
            headers: {
                "Content-Type": `application/json`
            },
...
var _defaultViewDefault = parcelHelpers.interopDefault(_defaultView);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _fracty = require("fracty");
var _fractyDefault = parcelHelpers.interopDefault(_fracty);
class ViewSelectedRecipe extends (0, _defaultViewDefault.default) {
  ...
  <svg class="recipe__icon">
    <use href="${0, _iconsSvgDefault.default}#icon-check"></use>
      ...
      <div class="recipe__quantity">${item.quantity ? (0, _fractyDefault.default)(item.quantity) : ""}</div>
...
exports.default = new ViewSelectedRecipe();

},{"./defaultView":"i5cJZ","url:../../img/icons.svg":"loVOp","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i5cJZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
    ...
    update(data) {
        ...
        this._data = data;
        const html = this._generateHtml();
        const newElements = Array.from(document.createRange().createContextualFragment(html).querySelectorAll(`*`));
        ...
        newElements.forEach(function(newElement, index) {
            ...
            if (!newElement.isEqualNode(oldElement) && newElement.firstChild?.nodeValue.trim() !== ``) // console.log(oldElement.textContent, newElement.textContent);
            oldElement.textContent = newElement.textContent;
            if (!newElement.isEqualNode(oldElement)) Array.from(newElement.attributes).forEach(function(attribute) {
...
},{}],"1ZJ8V":[function(require,module,exports) {
// import icons from 'url:../../img/icons.svg';
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _defaultView = require("./defaultView");
var _defaultViewDefault = parcelHelpers.interopDefault(_defaultView);
class SearchBarView extends (0, _defaultViewDefault.default) {
...
},{"./defaultView":"i5cJZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cXIN2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _defaultView = require("./defaultView");
var _defaultViewDefault = parcelHelpers.interopDefault(_defaultView);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _recipeListView = require("./recipeListView");
var _recipeListViewDefault = parcelHelpers.interopDefault(_recipeListView);
class SearchResultsView extends (0, _defaultViewDefault.default) {
    ...
    _generateHtml() {
        return this._data.map(function(recipe) {
            return (0, _recipeListViewDefault.default).render(recipe, false);
        }).join(``);
    }
}
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class RecipeListView extends (0, _defaultViewDefault.default) {
    _generateHtml() {
        const url = window.location.hash.slice(1);
        // console.log(this._data);
        return `
          <li class="preview">
          <a class="preview__link ${url === this._data.id ? `preview__link--active` : ``}" href="#${this._data.id}">
            <figure class="preview__fig">
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class PageButtonView extends (0, _defaultViewDefault.default) {
...
`;
        if (currentPage === 1 && lastPage === 1) //   console.log(`only 1 pg`);
        return pageIndicator;
        if (currentPage < lastPage && currentPage === 1) //   console.log(`page 1`);
        return pageIndicator + nextButton;
        if (currentPage < lastPage && 1 < currentPage) //   console.log(1 < currentPage);
        //   console.log(`page ${currentPage} out of ${lastPage}`);
        return previousButton + pageIndicator + nextButton;
        if (currentPage === lastPage && lastPage > 1) //   console.log(`last page`);
...
exports.default = new PageButtonView();

},{"./defaultView":"i5cJZ","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Lqzq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _defaultView = require("./defaultView");
var _defaultViewDefault = parcelHelpers.interopDefault(_defaultView);
...
var _recipeListView = require("./recipeListView");
var _recipeListViewDefault = parcelHelpers.interopDefault(_recipeListView);
class BookmarksView extends (0, _defaultViewDefault.default) {
...
},{"./defaultView":"i5cJZ","url:../../img/icons.svg":"loVOp","./recipeListView":"lQioO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _defaultView = require("./defaultView");
var _defaultViewDefault = parcelHelpers.interopDefault(_defaultView);
class AddRecipeView extends (0, _defaultViewDefault.default) {
        ...
        this._form.addEventListener(`submit`, function(event) {
            ...
            try {
                ...
                ingredientsArray.map(function(ingredient) {
                    ...
                    // console.log(ingredients);
                    if (ingredients.length !== 3) throw new Error(`3 items needed in format of "quantity,unit,description"`);
                });
                //   console.log(ingredients);
...
},{"./defaultView":"i5cJZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire3a11")
